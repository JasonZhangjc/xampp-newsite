...
<img src="<?php echo empty($result['avatar_path']) ? "uploads/78584.jpg" : $result['avatar_path']; ?>" class="rounded-circle" style="width: 25%; height: 25%" />
...
<div class="card" style="width: 20rem;">
    <div class="card-body">
        ...
        <p class="card-text">
            Personal Webpage: <?php echo $result['webpage']?>
        </p>
        <p class="card-text">
